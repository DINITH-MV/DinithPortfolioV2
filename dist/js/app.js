...
const image = document.getElementById('scroll-image');
  ...
  window.addEventListener('scroll', () => {
    ...
    if (scrollPosition > 60) { // Hide the image after scrolling 100px
      image.style.opacity = '0'; // Gradual disappearance
      image.style.transition = 'opacity 0.2s'; // Smooth transition
    } else {
      image.style.opacity = '1'; // Make it visible again when scrolling back up
    }
  });